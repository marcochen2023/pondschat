...
```bash
# 克隆專案
git clone https://github.com/marcochen2023/pondschat.git
cd pondschat
...
- GitHub: [Your GitHub Profile](https://github.com/marcochen2023)
...
- [PondsChat 文件](./docs)
- [問題回報](https://github.com/marcochen2023/pondschat/issues)
